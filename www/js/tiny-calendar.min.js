...
angular.module('angular-tiny-calendar', []).directive('tinyCalendar', [function() {
    ...
    return {
        ...
        template: function(element, attrs) {
            ...
            html += "</div>";
            html += "<div class='tc-focus'>";
            html += "<ul>";
            html += "<li ng-repeat='e in events | orderBy:&quot;date&quot;'><span class='tc-time' ng-show='e.time'>{{e.startDate | date: 'dd'}}</span><span class='tc-time' ng-hide='e.time'>" + attrs.allDayLabel + "</span><span class='tc-title'>{{e.status==1 ? 'Proposta Aprovada':'Oferta Feita'}}</span></li>";
            html += "</ul>";
            html += "</div>";
            html += "</div>";
